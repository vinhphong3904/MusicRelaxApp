...
import com.example.musicapp.core.network.AuthInterceptor;
import com.example.musicapp.core.network.NetworkModule_ProvideApiServiceFactory;
import com.example.musicapp.core.network.NetworkModule_ProvideGsonFactory;
import com.example.musicapp.core.network.NetworkModule_ProvideLoggingInterceptorFactory;
import com.example.musicapp.core.network.NetworkModule_ProvideOkHttpClientFactory;
import com.example.musicapp.core.network.NetworkModule_ProvideRetrofitFactory;
import com.example.musicapp.core.network.NetworkModule_ProvideSharedPreferencesFactory;
import com.example.musicapp.di.AppModule_ProvideAuthRepositoryFactory;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_example_musicapp_presentation_auth_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_example_musicapp_presentation_auth_AuthViewModel = "com.example.musicapp.presentation.auth.AuthViewModel";

      @KeepFieldType
      AuthViewModel com_example_musicapp_presentation_auth_AuthViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_example_musicapp_presentation_auth_AuthViewModel, ((Provider) authViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.musicapp.presentation.auth.AuthViewModel 
  ...
  private static final class SingletonCImpl extends MyApplication_HiltComponents.SingletonC {
    ...
    private AuthInterceptor authInterceptor() {
      return new AuthInterceptor(provideSharedPreferencesProvider.get());
    }

    private UserDataStore userDataStore() {
      return new UserDataStore(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.musicapp.domain.repository.AuthRepository 
          return (T) AppModule_ProvideAuthRepositoryFactory.provideAuthRepository(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.userDataStore());

          case 1: // com.example.musicapp.core.network.ApiService 
